...
// const guess2 = `Guess Who is ${firstName}`; //liz
// console.log("guess2: ", guess2); //donna
...
// const finalAnswer = guessWho(); //Gail
// console.log(finalAnswer);
...
changeGuess();
console.log(`Guess Who is ${guess.firstName}`); //error
